...
async def validate_cluster(name, namespace, meta, spec, operation, **kwargs):
    ...
    if not meta.get("deletionTimestamp"):
        await _validate_credentials_secret_exists(spec, namespace)
    ...
    await _validate_upgrade_compatibility(current_cluster, next_template)

    return next_template


async def _validate_credentials_secret_exists(spec, namespace):
...
async def _validate_upgrade_compatibility(current_cluster, next_template):
